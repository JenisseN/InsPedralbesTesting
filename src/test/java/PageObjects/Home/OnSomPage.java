...
public class OnSomPage extends PageBase {
    ...
    private By locatormsgObligatoryName = By.xpath("//form[@class='wpcf7-form invalid']//div[@class='vc_row make-an-appointment-form']//div[@class='vc_col-sm-6']//span" +
            "[@class='wpcf7-form-control-wrap your-name']//span[@class='wpcf7-not-valid-tip']");
    private By locatormsgObligatoryEmail = By.xpath("//form[@class='wpcf7-form invalid']//div[@class='vc_row make-an-appointment-form']//div[@class='vc_col-sm-6']//span" +
            "[@class='wpcf7-form-control-wrap your-email']//span[@class='wpcf7-not-valid-tip']");
    private By locatormsgInvalid = By.xpath("//form[@class='wpcf7-form invalid']//div[@class='vc_row make-an-appointment-form']//div[@class='vc_col-sm-6']//span" +
            "[@class='wpcf7-form-control-wrap your-email']//span[@class='wpcf7-not-valid-tip']");
    ...
    public boolean formulariIsDisplayed() throws Exception {
        return isDisplayed(locatorFieldName) && isDisplayed(locatorFieldEmail) &&
                isDisplayed(locatorFieldTopic) && isDisplayed(locatorFieldMessage)
